...
const FormControl =
  (Element: string | React.FC<React.HTMLProps<HTMLInputElement>>) =>
  (props: FieldProps & React.HTMLProps<HTMLInputElement>) => {
    ...
    return (
      <div
        className={[styles.formControl, hasError ? styles.error : ''].join(' ')}
      >
        <Element
