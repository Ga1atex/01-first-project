...
const state = {
  postsData: [
    { id: 1, message: 'Post1', likesCount: 431, isLiked: false, userName: 'UserName123', userId: 2 },
    { id: 2, message: 'Hey', likesCount: 431, isLiked: false, userName: 'UserName123', userId: 2 },
    { id: 3, message: 'Hi', likesCount: 431, isLiked: false, userName: 'UserName123', userId: 2 },
    { id: 4, message: 'How is your day123', likesCount: 222, isLiked: false, userName: 'UserName123', userId: 2 },
  ],
  profile: null,
...
test('length of posts should be incremented', () => {
  // 1. test data
  let action = profileActionCreators.addPost('123', '', 'Username', 2);
